...
- DO NOT
  - Ask about grades unless there is a mistake.
    ...
    - Tell me about your medical conditions. If you have a legitimate excuse for a long absence, contact the dean of
      students, who will then contact all the professors. You do not have to share private health information with us.
  ...
  - Assume that I check your messages on Saturday night and send multiple messages when I do not answer the first within
    12 hours.
  ...
  - Let an LLM think for you. If you do not learn to code, you will be worthless in the job market. AI may eventually
    ...
    the work, but the remaining 10% includes understanding how it works. The AI is not yet intelligent. It does not know
    what it is doing. It has just memorized a lot.
- DO
...
1. Setup
   - Do you have a laptop? If not, please contact me. I will try to arrange a loaner. You can live without one, but it
     is nice to have.
   - Do you want to buy a laptop? Prices are rising sharply on RAM. If you want to lock in,
     [Costco currently has the one I am using for $379, and several others are slightly more](https://www.costco.com/s?keyword=laptop).
...
3. Using virtual machines in the cloud
   ...
   - **Homework**: You will learn a subset of the Linux commands listed above, following instructions in a Colab step by
     step.
4. I/O
...
| 3    | 2/9  | C/C++, Compilers File I/O                                                                                                                         |                                                                      |          |                                                                                                                                                                                                  |
| 4    | 2/16 | Optimization, Linking, calling system code, memory allocation                                                                                     |                                                                      |          |                                                                                                                                                                                                  |
| 5    | 2/23 | Threads, more memory                                                                                                                              |                                                                      |          |                                                                                                                                                                                                  |
| 6    | 3/2  | Networking. Socket programming.                                                                                                                   |                                                                      |          |                                                                                                                                                                                                  |
| 7    | 3/9  | Processes (fork)                                                                                                                                  |                                                                      |          |                                                                                                                                                                                                  |
...
| 9    | 3/23 | Review: Fixing Misconceptions,                                                                                                                    |                                                                      |          |                                                                                                                                                                                                  |
| 10   | 3/30 | Buffer overflow, Crypto (in-class, use AES encryption to encode/decode a file)                                                                    |                                                                      |          |                                                                                                                                                                                                  |
| 11   | 4/6  | More Networking: UDP sockets, QUIC, Writing your own protocol?                                                                                    |                                                                      |          |                                                                                                                                                                                                  |
...
| Homework                               |        20% |
| In-class                               |        20% |
| Projects (larger homework assignments) |        20% |

## Academic Honesty

1. You are allowed to use AI, but you must learn the material yourself.
