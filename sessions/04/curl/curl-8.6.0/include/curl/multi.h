 ...
 * Returns:  CURLMcode type, general multi error code.
 */
CURL_EXTERN CURLMcode curl_multi_wait(CURLM* multi_handle, curl_waitfd extra_fds[], unsigned int extra_nfds,
 ...
 * Returns:  CURLMcode type, general multi error code.
 */
CURL_EXTERN CURLMcode curl_multi_poll(CURLM* multi_handle, curl_waitfd extra_fds[], unsigned int extra_nfds,
									  int timeout_ms, int* ret);
...
CURL_EXTERN char* curl_pushheader_bynum(curl_pushheaders* h, size_t num);
CURL_EXTERN char* curl_pushheader_byname(curl_pushheaders* h, const char* name);

typedef int (*curl_push_callback)(CURL* parent, CURL* easy, size_t num_headers, curl_pushheaders* headers, void* userp);
