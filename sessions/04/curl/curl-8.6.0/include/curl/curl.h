...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
#if defined(_AIX) || defined(__NOVELL_LIBC__) || defined(__NetBSD__) || defined(__minix) || defined(__INTEGRITY) ||    \
	defined(ANDROID) || defined(__ANDROID__) || defined(__OpenBSD__) || defined(__CYGWIN__) || defined(AMIGA) ||       \
	defined(__NuttX__) || (defined(__FreeBSD_version) && (__FreeBSD_version < 800000)) ||                              \
...
#define CURL_EXTERN
#elif defined(_WIN32) || (__has_declspec_attribute(dllexport) && __has_declspec_attribute(dllimport))
...
typedef int (*curl_trailer_callback)(curl_slist** list, void* userdata);
...
typedef curl_socket_t (*curl_opensocket_callback)(void* clientp, curlsocktype purpose, curl_sockaddr* address);
...
typedef int (*curl_prereq_callback)(void* clientp, char* conn_primary_ip, char* conn_local_ip, int conn_primary_port,
									int conn_local_port);
...
typedef CURLSTScode (*curl_hstsread_callback)(CURL* easy, curl_hstsentry* e, void* userp);
typedef CURLSTScode (*curl_hstswrite_callback)(CURL* easy, curl_hstsentry* e, curl_index* i, void* userp);
 ...
 */
CURL_EXTERN CURLcode curl_mime_headers(curl_mimepart* part, curl_slist* headers, int take_ownership);
 ...
 */
CURL_EXTERN int CURL_DEPRECATED(7.56.0, "") curl_formget(curl_httppost* form, void* arg, curl_formget_callback append);
/*
 * NAME curl_formfree()
 *
 * DESCRIPTION
 ...
 */
CURL_EXTERN void CURL_DEPRECATED(7.56.0, "Use curl_mime_free()") curl_formfree(curl_httppost* form);
 ...
 */
CURL_EXTERN curl_slist* curl_slist_append(curl_slist* list, const char* data);
...
typedef enum {
	...
	CURLINFO_CONTENT_LENGTH_DOWNLOAD CURL_DEPRECATED(7.55.0, "Use CURLINFO_CONTENT_LENGTH_DOWNLOAD_T") =
		CURLINFO_DOUBLE + 15,
