...
#ifdef USE_HYPER
typedef CURLcode (*Curl_datastream)(struct Curl_easy* data, struct connectdata* conn, int* didwhat, bool* done,
									int select_res);
#endif
...
struct Curl_handler {
	...
	/* If used, this function gets called from transfer.c:readwrite_data() to
	   ...
	   the client. */
	CURLcode (*write_resp)(struct Curl_easy* data, const char* buf, size_t blen, bool is_eos, bool* done);
