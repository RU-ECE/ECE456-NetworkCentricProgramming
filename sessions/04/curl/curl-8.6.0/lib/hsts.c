...
static struct stsentry* hsts_entry(void) { return calloc(1, sizeof(struct stsentry)); }
...
static CURLcode hsts_push(struct Curl_easy* data, struct curl_index* i, struct stsentry* sts, bool* stop) {
	...
	if (sts->expires != TIME_T_MAX) {
		...
		msnprintf(e.expire, sizeof(e.expire), "%d%02d%02d %02d:%02d:%02d", stamp.tm_year + 1900, stamp.tm_mon + 1,
