...
#if defined(__INTEL_COMPILER) && (__INTEL_COMPILER == 910) && defined(__OPTIMIZE__) && defined(__unix__) &&            \
	defined(__i386__)
...
int Curl_getaddrinfo_ex(const char* nodename, const char* servname, const struct addrinfo* hints,
...
int curl_dbg_getaddrinfo(const char* hostname, const char* service, const struct addrinfo* hints,
						 struct addrinfo** result, int line, const char* source) {
#ifdef USE_LWIPSOCK
