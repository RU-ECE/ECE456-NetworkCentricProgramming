...
CURLcode Curl_dyn_addf(struct dynbuf* s, const char* fmt, ...) WARN_UNUSED_RESULT CURL_PRINTF(2, 3);
CURLcode Curl_dyn_vaddf(struct dynbuf* s, const char* fmt, va_list ap) WARN_UNUSED_RESULT CURL_PRINTF(2, 0);
