...
#if defined(USE_OPENSSL) || defined(USE_WOLFSSL) || (defined(USE_NGTCP2) && defined(USE_NGHTTP3)) || defined(USE_QUICHE)
...
bool Curl_tls_keylog_write(const char* label, const unsigned char client_random[CLIENT_RANDOM_SIZE],
