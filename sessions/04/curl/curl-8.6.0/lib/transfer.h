...
CURLcode Curl_follow(Curl_easy *data, char *newurl,
                     followtype type);
CURLcode Curl_readwrite(Curl_easy *data, bool *done);
int Curl_single_getsock(Curl_easy *data,
                        struct connectdata *conn, curl_socket_t *socks);
CURLcode Curl_fillreadbuffer(Curl_easy *data, size_t bytes,
                             size_t *nreadp);
...
CURLcode Curl_done_sending(Curl_easy *data,
 ...
 */
CURLcode Curl_xfer_write_resp(Curl_easy *data,
                              char *buf, size_t blen,
                              bool is_eos, bool *done);

/* This sets up a forthcoming transfer */
void
Curl_setup_transfer (Curl_easy *data,
