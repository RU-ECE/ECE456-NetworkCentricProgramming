...
#include "curl_setup.h"
	...
	!defined(CURL_DISABLE_DIGEST_AUTH) || !defined(CURL_DISABLE_DOH) || defined(USE_SSL) || defined(BUILDING_CURL)
#include "curl/curl.h"
...
static CURLcode base64_encode(const char* table64, const char* inputbuff, size_t insize, char** outptr,
							  size_t* outlen) {
	char* output;
	char* base64data;
