...
struct Curl_addrinfo* Curl_ipv4_resolve_r(const char* hostname, int port) {
	...
	h = gethostbyname_r(hostname, (struct hostent*)buf, (char*)buf + sizeof(struct hostent),
	...
	(void)gethostbyname_r(hostname, (struct hostent*)buf, (char*)buf + sizeof(struct hostent),
	...
	if (CURL_HOSTENT_SIZE >= (sizeof(struct hostent) + sizeof(struct hostent_data))) {
		...
		res = gethostbyname_r(hostname, (struct hostent*)buf,
