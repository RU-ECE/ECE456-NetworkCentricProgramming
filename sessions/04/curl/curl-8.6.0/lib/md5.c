...
static void my_md5_final(unsigned char* digest, my_md5_ctx* ctx) { md5_digest(ctx, 16, digest); }
...
static void my_md5_final(unsigned char* digest, my_md5_ctx* ctx) { (void)MD5_Final(digest, ctx); }
...
static void my_md5_final(unsigned char* digest, my_md5_ctx* ctx) { CC_MD5_Final(digest, ctx); }
