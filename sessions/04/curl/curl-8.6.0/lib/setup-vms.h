...
static int CONF_modules_load_file(const char* filename, const char* appname, unsigned long flags) { return 1; }
#endif
#endif
...
static int des_set_key(const_des_cblock* key, des_key_schedule schedule) { return DES_SET_KEY(key, schedule); }
