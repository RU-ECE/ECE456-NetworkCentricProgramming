...
static void my_sha256_final(unsigned char* digest, my_sha256_ctx* ctx) { (void)CC_SHA256_Final(digest, ctx); }
...
#define WPA_GET_BE32(a)                                                                                                \
	((((unsigned long)(a)[0]) << 24) | (((unsigned long)(a)[1]) << 16) | (((unsigned long)(a)[2]) << 8) |              \
	 ((unsigned long)(a)[3]))
