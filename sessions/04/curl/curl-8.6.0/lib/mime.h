...
CURLcode Curl_mime_add_header(curl_slist** slp, const char* fmt, ...) CURL_PRINTF(2, 3);
...
CURLcode Curl_mime_prepare_headers(Curl_easy* data, curl_mimepart* part, const char* contenttype,
