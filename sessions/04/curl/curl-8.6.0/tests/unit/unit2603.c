...
static struct tcase TEST1b = {T1_INPUT, "https", "GET", "https", NULL, "/path", 1, 0};
...
static struct tcase TEST3a = {T3_INPUT, NULL, "GET", "ftp", "ftp.curl.se", "/xxx?a=2", 2, 0};
...
static struct tcase TEST4a = {T4_INPUT, NULL, "CONNECT", NULL, "ftp.curl.se:123", NULL, 3, 2};
