...
rc = curl_formadd(&post, &last, CURLFORM_COPYNAME, "name", CURLFORM_COPYCONTENTS, "content", CURLFORM_END);
...
rc = curl_formadd(&post, &last, CURLFORM_COPYNAME, "htmlcode", CURLFORM_COPYCONTENTS, "<HTML></HTML>",
				  CURLFORM_CONTENTTYPE, "text/html", CURLFORM_END);

fail_unless(rc == 0, "curl_formadd returned error");

rc = curl_formadd(&post, &last, CURLFORM_COPYNAME, "name_for_ptrcontent", CURLFORM_PTRCONTENTS, buffer, CURLFORM_END);
...
rc = curl_formadd(&post, &last, CURLFORM_PTRNAME, "name of file field", CURLFORM_FILE, arg, CURLFORM_FILENAME,
				  "custom named file", CURLFORM_END);
