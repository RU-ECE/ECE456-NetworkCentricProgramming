...
OM_uint32 gss_init_sec_context(OM_uint32* min, gss_const_cred_id_t initiator_cred_handle, gss_ctx_id_t* context_handle,
							   gss_const_name_t target_name, const gss_OID mech_type, OM_uint32 req_flags,
	...
	*min = 0;
	...
	/* Note: this is using the *real* snprintf() and not the curl provided
	   one */
	used = (size_t)snprintf(token, length, "%s:%s:%d:", creds, (char*)target_name, ctx->sent);
...
OM_uint32 gss_import_name(OM_uint32* min, const gss_buffer_t input_name_buffer, const gss_OID input_name_type,
...
OM_uint32 gss_display_status(OM_uint32* min, OM_uint32 status_value, int status_type, const gss_OID mech_type,
...
OM_uint32 gss_display_name(OM_uint32* min, gss_const_name_t input_name, gss_buffer_t output_name_buffer,
...
OM_uint32 gss_inquire_context(OM_uint32* min, gss_const_ctx_id_t context_handle, gss_name_t* src_name,
...
OM_uint32 gss_wrap(OM_uint32* min, gss_const_ctx_id_t context_handle, int conf_req_flag, gss_qop_t qop_req,
				   const gss_buffer_t input_message_buffer, int* conf_state, gss_buffer_t output_message_buffer) {
	(void)min;
	(void)context_handle;
	(void)conf_req_flag;
	(void)qop_req;
...
OM_uint32 gss_unwrap(OM_uint32* min, gss_const_ctx_id_t context_handle, const gss_buffer_t input_message_buffer,
...
OM_uint32 gss_seal(OM_uint32* min, gss_ctx_id_t context_handle, int conf_req_flag, int qop_req,
...
OM_uint32 gss_unseal(OM_uint32* min, gss_ctx_id_t context_handle, gss_buffer_t input_message_buffer,
