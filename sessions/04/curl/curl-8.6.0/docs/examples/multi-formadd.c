...
int main(void) {
	...
	curl_formadd(&formpost, &lastptr, CURLFORM_COPYNAME, "sendfile", CURLFORM_FILE, "multi-formadd.c", CURLFORM_END);

	/* Fill in the filename field */
	curl_formadd(&formpost, &lastptr, CURLFORM_COPYNAME, "filename", CURLFORM_COPYCONTENTS, "multi-formadd.c",
				 CURLFORM_END);
