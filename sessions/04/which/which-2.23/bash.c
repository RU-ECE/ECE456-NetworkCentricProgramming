...
/* Information about the current user. */
struct user_info current_user = {(uid_t)-1, (uid_t)-1, (GID_T)-1, (GID_T)-1, (char*)NULL, (char*)NULL, (char*)NULL};
...
/* Return 1 if STRING is an absolute program name; it is absolute if it
   ...
   up through $PATH. */
int contains_separator(char const* string) { return CONTAINS_SEPARATOR(string); }
...
char* sh_get_env_value(const char* v) { return getenv(v); }
#ifndef _WIN32
